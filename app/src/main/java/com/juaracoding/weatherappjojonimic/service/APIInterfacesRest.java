package com.juaracoding.weatherappjojonimic.service;
 ...
 */
 ...
 public interface APIInterfacesRest {
  ...
  @GET("weather")
    Call<ModelWeather> getWeather(@Query("lat") Double lat, @Query("lon") Double lon, @Query("appid") String appid);
//
  @GET("weather")
    Call<ModelWeather> getWeatherByCity(@Query("q") String q, @Query("appid") String appid);
//
//    @GET("forecast")
//    Call<ForcastWeatherModel> getForecastBasedLocation(@Query("lat") Double lat, @Query("lon") Double lon, @Query("appid") String appid);
//
//    @GET("forecast")
//    Call<ForcastWeatherModel> getForecastByCity(@Query("q") String q, @Query("appid") String appid);
